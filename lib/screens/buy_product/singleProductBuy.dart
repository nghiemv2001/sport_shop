...
class singleProductBuy extends StatefulWidget {
  final Product singProduct;
  const singleProductBuy({Key? key, required this.singProduct})
      : super(key: key);

  @override
  State<singleProductBuy> createState() => _singleProductBuyState();
}

class _singleProductBuyState extends State<singleProductBuy> {
  int groupvalue = 1;
  int qty = 0;
  @override
  void initState() {
